				...
				<div className='flex mr-20'>
					<Card className='bg-white p-2 max-h-80'>
						<div>
							...
							<div className='mt-4'>
								<TextField label="Password" color='grey' focused />
							</div>
							<div className='mt-4'>
								<FormControl fullWidth >
									...
									>
										<MenuItem value={'p1'}>{'Eszközfelelős'}</MenuItem>
										<MenuItem value={'p2'}>{'Operátor'}</MenuItem>
										<MenuItem value={'p3'}>{'Karbantartó'}</MenuItem>
									</Select>
								</FormControl>
							</div>
							...
							<div className='mt-4'>
								<FormControl fullWidth >
									...
									<Select
										...
										onChange={handleChange}
									>
										<MenuItem value={'p1'}>{'name1'}</MenuItem>
										<MenuItem value={'p2'}>{'name2'}</MenuItem>
										<MenuItem value={'p3'}>{'name3'}</MenuItem>
									</Select>
								</FormControl>
								<div className='mt-4'>
									<FormControl fullWidth >
